...
\begin{enumerate}[(a)]
        ...
        \item %(g) 
            Using K-fold cross validation would be able to find the best fit in the data. The average error on traning data would be keeping decrease while the order in
